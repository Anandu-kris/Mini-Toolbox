...
> = {
  focus: {
    ...
    accent: "#3b82f6",
    dot: "#93c5fd",
    tab: "rgba(59,130,246,0.2)",
    glowBtn: "rgba(59,130,246,0.45)",
  },
  short: {
    ring: "#34d399",
    ...
    accent: "#10b981",
    dot: "#6ee7b7",
    tab: "rgba(16,185,129,0.2)",
    glowBtn: "rgba(16,185,129,0.45)",
  },
  long: {
    ring: "#a78bfa",
    ...
    accent: "#8b5cf6",
    dot: "#c4b5fd",
    tab: "rgba(139,92,246,0.2)",
    glowBtn: "rgba(139,92,246,0.45)",
  },
};
      ...
      >
        ...
        {ticks.map((t, i) => (
          <line
            ...
            y2={t.y2}
            stroke={
              t.isMajor ? "rgba(255,255,255,0.28)" : "rgba(255,255,255,0.09)"
            }
        ...
        {progress > 0 && (
          <circle
            ...
            style={{
              ...
              transition:
                "cx 0.8s cubic-bezier(.4,0,.2,1), cy 0.8s cubic-bezier(.4,0,.2,1)",
            }}
          />
        )}
      </svg>
...
export default function PomodoroTimer({
  ...
  onTimerStateChange?: (state: { mode: Mode; isRunning: boolean }) => void;
}) {
  ...
  }, [mode, running, onTimerStateChange]);
            ...
            {mode === "focus" && (
              <div className="pomo-dots">
                {Array.from({ length: CYCLE }, (_, i) => (
                  <div
                    key={i}
                    className={`pomo-dot${i < pomodoroCount ? " pd-filled" : ""}`}
                  />
                ))}
              </div>
            )}
