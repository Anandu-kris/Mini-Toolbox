...
} from "@/components/Pomodoro/PomodoroSettings";
import { Settings, Timer, Brain, Coffee, Target } from "lucide-react";
import FocusAudioModal from "@/components/Pomodoro/FocusAudioModal";
...
function loadDurations(): PomodoroDurations {
  try {
    ...
    return {
      focus: Number(p.focus) || 25,
      short: Number(p.short) || 5,
      long: Number(p.long) || 20,
    };
  } catch {
      ...
      <div className="pp-shell">
        <div className="pp-inner">
          <div className="pp-left">
            ...
            <p className="pp-sub">
              Transform scattered hours into laser-focused sessions. Work in
              timed sprints, rest intentionally, and watch your output compound
              every single day.
            </p>
          ...
          <div className="pp-right">
            <PomodoroTimer
              ...
              onTimerStateChange={({ mode, isRunning }) => {
                setTimerMode(mode);
